...
import licenta.model.UserPrincipal;
import licenta.model.dto.LoginRequestDTO;
import licenta.utils.JwtProperties;
...
import static licenta.utils.JwtProperties.HEADER_STRING;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        final String basicAuth = request.getHeader(HEADER_STRING);
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) {
        ...
        response.addHeader(HEADER_STRING, JwtProperties.TOKEN_PREFIX + token);
    }
