...
import licenta.utils.GeneralConfig;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .antMatchers(HttpMethod.GET, "/auth/get-user").permitAll()
                .antMatchers(HttpMethod.GET, "/auth/get-user/{id}").permitAll()
                // admin permissions
                .antMatchers(HttpMethod.POST, "/admin/save-account").permitAll()
                .antMatchers(HttpMethod.GET, "/admin/get-accounts").permitAll()
                .antMatchers(HttpMethod.DELETE, "/admin/delete/{id}").permitAll()
                .antMatchers(HttpMethod.PUT, "/admin/update-account/{id}").permitAll()
                // doctor permissions
                .antMatchers(HttpMethod.GET, "/doctor/get-patients").permitAll()
                .antMatchers(HttpMethod.POST, "/doctor/add-analysis").permitAll()
                .antMatchers(HttpMethod.GET, "/doctor/get-analysis/{id}").permitAll()
                .antMatchers(HttpMethod.GET, "/doctor/get-consultation/{id}").permitAll()
                .antMatchers(HttpMethod.POST, "/doctor/add-consultation").permitAll()
                // patient permissions
                .antMatchers(HttpMethod.GET, "/patient/get-last-consultation/{id}").permitAll()
